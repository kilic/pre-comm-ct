...
contract ZKToken16 is ZKTokenUtil{
  
  uint256 public constant N = 16;
  // 10 ** 15 Wei, 0.001 ETH, 1 Finney
  uint256 public constant BaseWei = 1000000000000000;
  // 10 ** 15 Wei, 0.001 ETH, 1 Finney
  uint256 public constant StepWei = 1000000000000000;
  // 65.536 ETH
